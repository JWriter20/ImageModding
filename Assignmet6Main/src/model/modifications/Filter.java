...
public abstract class Filter implements IModifyImage {
   ...
   * of the pixel.
   * @param img The image the kernel is being applied to.
   * @param x The x coordinate of the pixel that is to be changed.
   * @param y The y coordinate of the pixel that is to be changed.
   * @return The new Color of the pixel after the modification has been applied.
   */
