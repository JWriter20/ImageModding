...
public class CustomCheckerBoard extends AbstractImage {
   ...
   * @param squareLength The length of each checker square in the checkerboard.
   * @param width the width in checkers of the checkerboard
   * @param height the height in checkers of the checkerboard
   */
