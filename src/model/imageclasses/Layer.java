...
/**
 * Represents one layer of a possibly multi-layered image. A layer has
 * an image that can be modified, a name to identify the layer, and the
 * ability to set the layer to invisible.
 */
public class Layer {
